...
public class RegisterTentItemActivity extends AppCompatActivity {
    ...
    private ProductPersistence product = new ProductPersistence();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] lista = product.getNameProducts();
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,product.getNameProducts());
