...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //UserInterest
    private static final String TABLE_USERPRODUCT_NAME = "user_product";
    ...
    public static String getTableUserproductName() {
        return TABLE_USERPRODUCT_NAME;
    }
